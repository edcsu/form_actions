...
import { isEmail, 
  isNotEmpty, 
  hasMinLength, 
  isEqualToOtherValue} from '../util/validation'
      ...
      <fieldset>
        ...
        <div className="control">
          <input
            ...
            name="acquisition"
            value="linkedin"
            defaultChecked={formState.enteredValues?.acquisitionChannel.includes('linkedin')}   
            />
        ...
        <div className="control">
          <input
            ...
            name="acquisition"
            value="tiktok"
            defaultChecked={formState.enteredValues?.acquisitionChannel.includes('tiktok')}   
            />
        ...
        <div className="control">
          <input
            ...
            name="acquisition"
            value="x"
            defaultChecked={formState.enteredValues?.acquisitionChannel.includes('x')}   
          />
